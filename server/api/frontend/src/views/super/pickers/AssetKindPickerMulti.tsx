...
type AssetKindPickerMultiProps = {
   className?: string;
   id?: string;
   value?: string[];
   null_display?: string;
...
function AssetKindPickerMulti(props: AssetKindPickerMultiProps) {
   ...
   const assetkinds: Option[] = [
      { value: '0', display: 'image' },
      { value: '1', display: 'audio' },
      { value: '2', display: 'avatar' },
   ];
   ...
   const findOptionLabel = (value?: string): string => {
      return assetkinds.find(t => t.value === value)?.display ?? '';
   };
...
export default AssetKindPickerMulti;