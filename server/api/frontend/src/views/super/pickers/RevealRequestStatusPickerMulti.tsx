...
type RevealRequestStatusPickerMultiProps = {
   className?: string;
   id?: string;
   value?: string[];
   null_display?: string;
...
function RevealRequestStatusPickerMulti(props: RevealRequestStatusPickerMultiProps) {
   ...
   const findOptionLabel = (value?: string): string => {
      return revealrequeststatuss.find(t => t.value === value)?.display ?? '';
   };
   ...
   return (
      <Select
         ...
         options={revealrequeststatuss}
         className={classNames(className)}
      />
   );
}

export default RevealRequestStatusPickerMulti;