...
type AuthorizedDeviceRequestStatusPickerProps = {
   className?: string;
   id?: string;
   value?: string;
   null_display?: string;
...
function AuthorizedDeviceRequestStatusPicker(props: AuthorizedDeviceRequestStatusPickerProps) {
...
export default AuthorizedDeviceRequestStatusPicker;