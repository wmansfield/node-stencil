...
type AgeBracketPickerMultiProps = {
   className?: string;
   id?: string;
   value?: string[];
   null_display?: string;
...
function AgeBracketPickerMulti(props: AgeBracketPickerMultiProps) {
   ...
   const agebrackets: Option[] = [
      ...
      { value: '1', display: 'Adult (18+)' },
      { value: '2', display: 'Teen (16-17)' },
      { value: '3', display: 'Young Teen (13-15)' },
   ];
   ...
   const findOptionLabel = (value?: string): string => {
      return agebrackets.find(t => t.value === value)?.display ?? '';
   };
...
export default AgeBracketPickerMulti;