...
type TrustLevelPickerMultiProps = {
   className?: string;
   id?: string;
   value?: string[];
   null_display?: string;
...
function TrustLevelPickerMulti(props: TrustLevelPickerMultiProps) {
   ...
   const trustlevels: Option[] = [
      { value: '0', display: 'zero' },
      { value: '1', display: 'custodian' },
   ];
   ...
   const findOptionLabel = (value?: string): string => {
      return trustlevels.find(t => t.value === value)?.display ?? '';
   };
...
export default TrustLevelPickerMulti;