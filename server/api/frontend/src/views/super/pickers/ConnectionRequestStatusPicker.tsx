...
type ConnectionRequestStatusPickerProps = {
   className?: string;
   id?: string;
   value?: string;
   null_display?: string;
...
function ConnectionRequestStatusPicker(props: ConnectionRequestStatusPickerProps) {
...
export default ConnectionRequestStatusPicker;