...
function TierModePickerMulti(props: TierModePickerMultiProps) {
   ...
   const findOptionLabel = (value?: string): string => {
      return tiermodes.find(t => t.value === value)?.display ?? '';
   };
...
export default TierModePickerMulti;