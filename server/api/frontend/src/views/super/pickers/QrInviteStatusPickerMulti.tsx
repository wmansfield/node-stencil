...
type QrInviteStatusPickerMultiProps = {
   className?: string;
   id?: string;
   value?: string[];
   null_display?: string;
...
function QrInviteStatusPickerMulti(props: QrInviteStatusPickerMultiProps) {
   ...
   const findOptionLabel = (value?: string): string => {
      return qrinvitestatuss.find(t => t.value === value)?.display ?? '';
   };
   ...
   return (
      <Select
         ...
         options={qrinvitestatuss}
         className={classNames(className)}
      />
   );
}

export default QrInviteStatusPickerMulti;