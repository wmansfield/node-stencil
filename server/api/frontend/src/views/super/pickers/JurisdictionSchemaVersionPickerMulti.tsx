...
type JurisdictionSchemaVersionPickerMultiProps = {
   className?: string;
   id?: string;
   value?: string[];
   null_display?: string;
...
function JurisdictionSchemaVersionPickerMulti(props: JurisdictionSchemaVersionPickerMultiProps) {
...
export default JurisdictionSchemaVersionPickerMulti;