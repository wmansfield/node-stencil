...
type AccessTierPickerMultiProps = {
   className?: string;
   id?: string;
   value?: string[];
   null_display?: string;
...
function AccessTierPickerMulti(props: AccessTierPickerMultiProps) {
   ...
   const accesstiers: Option[] = [
      { value: '0', display: 'free' },
      { value: '1', display: 'keeper' },
   ];
   ...
   const findOptionLabel = (value?: string): string => {
      return accesstiers.find(t => t.value === value)?.display ?? '';
   };
...
export default AccessTierPickerMulti;