...
type CapsuleTargetKindPickerMultiProps = {
   className?: string;
   id?: string;
   value?: string[];
   null_display?: string;
...
function CapsuleTargetKindPickerMulti(props: CapsuleTargetKindPickerMultiProps) {
...
export default CapsuleTargetKindPickerMulti;