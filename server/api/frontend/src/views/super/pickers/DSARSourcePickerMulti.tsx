...
type DSARSourcePickerMultiProps = {
   className?: string;
   id?: string;
   value?: string[];
   null_display?: string;
...
function DSARSourcePickerMulti(props: DSARSourcePickerMultiProps) {
   ...
   const dsarsources: Option[] = [
      { value: '0', display: 'DataRep' },
      { value: '1', display: 'Direct Email' },
      { value: '2', display: 'In-App' },
   ];
   ...
   const findOptionLabel = (value?: string): string => {
      return dsarsources.find(t => t.value === value)?.display ?? '';
   };
...
export default DSARSourcePickerMulti;