...
type AgeSourcePickerMultiProps = {
   className?: string;
   id?: string;
   value?: string[];
   null_display?: string;
...
function AgeSourcePickerMulti(props: AgeSourcePickerMultiProps) {
   ...
   const agesources: Option[] = [
      { value: '0', display: 'Self Declared' },
      { value: '1', display: 'Apple Declared Age Range' },
      { value: '2', display: 'Google Play Age Signals' },
   ];
   ...
   const findOptionLabel = (value?: string): string => {
      return agesources.find(t => t.value === value)?.display ?? '';
   };
...
export default AgeSourcePickerMulti;