...
const NumberFormatInput = ({ onValueChange, ...rest }: NumberFormatInputProps) => {
   return <PatternFormat customInput={NumberInput as ComponentType} onValueChange={onValueChange} {...rest} />;
};

const PatternInput = ({ inputSuffix, inputPrefix, onValueChange, ...rest }: PatternInputProps) => {
   return <NumberFormatInput inputPrefix={inputPrefix} inputSuffix={inputSuffix} onValueChange={onValueChange} {...rest} />;
};
