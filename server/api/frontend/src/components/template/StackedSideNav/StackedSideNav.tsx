...
import { SPLITTED_SIDE_NAV_MINI_WIDTH, STACKED_SIDE_NAV_SECONDARY_WIDTH, DIR_LTR, DIR_RTL } from '@/constants/theme.constant';
...
const StackedSideNav = ({ translationSetup = appConfig.activeNavTranslation }: { translationSetup?: boolean }) => {
