...
type Layouts = Record<string, LazyExoticComponent<<T extends CommonProps>(props: T) => JSX.Element>>;

interface ProtectedLayoutProps extends CommonProps {
...
const ProtectedLayout = ({ layoutType, children }: ProtectedLayoutProps) => {
